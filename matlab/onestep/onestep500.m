...
p11=(1/b1)*(a1+r1*log(C1*x1+D1)-log(xx1(5))+log(1-xx1(5)-xx1(6)-xx1(7)-xx1(8)))
p12=(1/b2)*(a2+r2*log(C2*x2+D2)-log(xx1(6))+log(1-xx1(5)-xx1(6)-xx1(7)-xx1(8)))
p13=(1/b3)*(a3+r3*log(C3*x3+D3)-log(xx1(7))+log(1-xx1(5)-xx1(6)-xx1(7)-xx1(8)))
p14=(1/b4)*(a4+r4*log(C4*x4+D4)-log(xx1(8))+log(1-xx1(5)-xx1(6)-xx1(7)-xx1(8)))
p21=(1/b1)*(a1+r1*log(C1*xx1(5)+D1)-log(xx1(1))+log(1-xx1(1)-xx1(2)-xx1(3)-xx1(4)))
p22=(1/b2)*(a2+r2*log(C2*xx1(6)+D2)-log(xx1(2))+log(1-xx1(1)-xx1(2)-xx1(3)-xx1(4)))
p23=(1/b3)*(a3+r3*log(C3*xx1(7)+D3)-log(xx1(3))+log(1-xx1(1)-xx1(2)-xx1(3)-xx1(4)))
p24=(1/b4)*(a4+r4*log(C4*xx1(8)+D4)-log(xx1(4))+log(1-xx1(1)-xx1(2)-xx1(3)-xx1(4)))
